      ...
      <div className="pb-16">
        <Tabs defaultValue="main" className="gap-0">
          <TabsList className="w-full text-primary py-8 md:py-4">
            <TabsTrigger value="main" className="rounded-none w-[50%] flex flex-col md:flex-row py-8 md:py-4">
              <span>Executive Briefing</span>
              <span>(25 Agustus 2025)</span>
            </TabsTrigger>
            <TabsTrigger value="second" className="rounded-none w-[50%] flex flex-col md:flex-row py-8 md:py-4">
